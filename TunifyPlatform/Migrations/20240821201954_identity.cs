    ...
    public partial class identity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "admin@example.com", new DateTime(2024, 8, 21, 23, 19, 54, 731, DateTimeKind.Local).AddTicks(9469), 1, "admin" },
                    { 2, "user1@example.com", new DateTime(2024, 8, 11, 23, 19, 54, 731, DateTimeKind.Local).AddTicks(9481), 1, "user1" },
                    { 3, "user2@example.com", new DateTime(2024, 8, 1, 23, 19, 54, 731, DateTimeKind.Local).AddTicks(9488), 2, "user2" },
                    { 4, "user3@example.com", new DateTime(2024, 7, 22, 23, 19, 54, 731, DateTimeKind.Local).AddTicks(9490), 2, "user3" },
                    { 5, "user4@example.com", new DateTime(2024, 7, 12, 23, 19, 54, 731, DateTimeKind.Local).AddTicks(9491), 1, "user4" }
                });
