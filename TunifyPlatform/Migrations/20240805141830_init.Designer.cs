            ...
            modelBuilder.Entity("TunifyPlatform.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 8, 5, 17, 18, 29, 810, DateTimeKind.Local).AddTicks(2465),
                            SubscriptionId = 1,
                            Username = "admin"
                        },
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 7, 26, 17, 18, 29, 810, DateTimeKind.Local).AddTicks(2489),
                            SubscriptionId = 1,
                            Username = "user1"
                        },
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 7, 16, 17, 18, 29, 810, DateTimeKind.Local).AddTicks(2502),
                            SubscriptionId = 2,
                            Username = "user2"
                        },
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 7, 6, 17, 18, 29, 810, DateTimeKind.Local).AddTicks(2504),
                            SubscriptionId = 2,
                            Username = "user3"
                        },
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 6, 26, 17, 18, 29, 810, DateTimeKind.Local).AddTicks(2507),
                            SubscriptionId = 1,
                            Username = "user4"
                        });
                });
