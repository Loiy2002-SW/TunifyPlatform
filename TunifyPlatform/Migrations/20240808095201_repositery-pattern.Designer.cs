...
namespace TunifyPlatform.Migrations
{
    ...
    [Migration("20240808095201_repositery-pattern")]
    partial class repositerypattern
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TunifyPlatform.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 8, 8, 12, 52, 1, 75, DateTimeKind.Local).AddTicks(6527),
                            SubscriptionId = 1,
                            Username = "admin"
                        },
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 7, 29, 12, 52, 1, 75, DateTimeKind.Local).AddTicks(6540),
                            SubscriptionId = 1,
                            Username = "user1"
                        },
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 7, 19, 12, 52, 1, 75, DateTimeKind.Local).AddTicks(6546),
                            SubscriptionId = 2,
                            Username = "user2"
                        },
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 7, 9, 12, 52, 1, 75, DateTimeKind.Local).AddTicks(6548),
                            SubscriptionId = 2,
                            Username = "user3"
                        },
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 6, 29, 12, 52, 1, 75, DateTimeKind.Local).AddTicks(6549),
                            SubscriptionId = 1,
                            Username = "user4"
                        });
                });
